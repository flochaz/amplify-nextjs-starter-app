...
import { createAllee } from "./graphql/mutations";
const client = generateClient();
export default function AlleeCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setLettre(initialValues.Lettre);
    setErrors({});
  };
  const validations = {
    Lettre: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createAllee.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "AlleeCreateForm")}
      {...rest}
    >
      <TextField
        label="Lettre"
